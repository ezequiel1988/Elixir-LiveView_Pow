defmodule MyApp.CommentsTest do
  use MyApp.DataCase
  ...
  describe "comments" do
    ...
    @valid_attrs %{body: "some body", like: true, number_like: 42, title: "some title"}
    ...
    test "create_comment/1 with valid data creates a comment" do
      ...
      assert comment.like == true
      assert comment.number_like == 42
    ...
    test "update_comment/2 with valid data updates the comment" do
      ...
      assert comment.like == false
      assert comment.number_like == 43
